...
Format each recipe clearly with Title, Prep/Cook Time, Ingredients, and Instructions. Return only the clear text.`;
    ...
    try {
        ...
        res.json({ message: "Recipes successfully generated by AI Agent and printed to terminal." });
    } catch (error) {
        console.error("\n[!] AI Generation Error:", error.message || error);
        console.error("Make sure your GEMINI_API_KEY is correctly set in the server/.env file.\n");
